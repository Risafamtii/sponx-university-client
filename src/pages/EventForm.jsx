...
const EventForm = () => {
  return (
    <div className="flex justify-center items-center min-h-screen bg-light-blue font-inter">
      <div className="bg-white p-8 shadow-md rounded-md w-full max-w-3xl mt-16 mb-16">
        ...
        <form>
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-200 placeholder:text-sm placeholder:text-gray-400"
            />
          </div>
          <div className="mb-4">
          ...
          <div className="mb-8">
            ...
            <div className="mb-8">
            <label htmlFor="eventProposal" className="block text-gray-600 mb-2">Upload Event Proposal</label>
            <label
                htmlFor="eventProposal"
                className="inline-block bg-dark-blue text-white px-4 py-2 rounded-md cursor-pointer hover:bg-indigo-700"
            >
                Upload
            </label>
            ...
            <div className="mb-6">
            <label className="block text-gray-600 mb-8">
              Select Companies for Sponsorship Request
            </label>
            <div className="space-y-4">
              {["Company XYZ", "Company ABC", "Company DEF", "Company GHI"].map(
                (company, index) => (
                  <div
                    key={index}
                  ...
                  >
                    <label className="flex items-center space-x-2">
                      <input
                        type="checkbox"
                        className="w-4 h-4 border-gray-300 rounded focus:ring focus:ring-indigo-200"
                      />
                      <span className="text-gray-600">{company}</span>
                    </label>
                    <img src="wso2.png" className="w-10 h-10 rounded-full object-cover"/>
