    ...
    <div className="bg-white w-[83%] ml-[17%] mt-[5%] rounded-xl shadow-lg flex flex-col items-center py-4 h-[90vh] overflow-y-auto">
      ...
      {activeBar === "Approved" && (
        <>
          ...
          <div className="p-4 bg-white border-2 shadow-2xl w-[97%] mt-4 rounded-2xl">
              ...
              <table className="w-full bg-white rounded-lg shadow">
                ...
                <tbody className="text-sm text-gray-700">
                  {activities.map((activity, index) => (
                    <tr key={index} className="transition duration-200 border-b hover:bg-gray-100">
                      ...
                      <td className="px-6 py-4 text-center">{activity.dueDate}</td>
                      <td className="px-6 py-4 text-center">{activity.progress}</td>
                      <td className="px-6 py-4 text-center">
                        <span className="px-3 py-1 text-xs font-semibold text-green-600 bg-green-100 rounded-full">{activity.status}</span>
                      </td>
                      <td className="px-6 py-4 text-center">
      ...
      {activeBar === "Pending" && (
        <>
          ...
          <div className="flex flex-col items-center w-full gap-4 mt-4">
            {eventCard.length > 0 && ( // Ensure eventCard is not empty
              <div key={eventCard[0].id} className='w-[90%] bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-200'>

                <div className='relative'>
                  <img src={coverpic} alt="Cover" className='object-cover w-full h-20'/>
                  <img src={eventCard[0].eventImage} alt="Profile" className='absolute left-6 bottom-[-20px] h-16 w-16 rounded-full border-4 border-white shadow-lg' />
                </div>

                <div className="px-4 py-6">
                  <div className='flex items-center justify-between'>
                    <h2 className='text-xl font-extrabold text-gray-800'>{eventCard[0].title}</h2>
                  ...
                  <div className='flex items-center justify-center gap-20 mt-4 font-medium text-gray-700 text-md'>
                    <div className='flex items-center gap-2'><img src={propic} alt="" className='h-4'/> John Doe</div>
                    <div className='flex items-center gap-2'><img src={location} alt="" className='h-4'/> Colombo 7</div>
                    <div className='flex items-center gap-2'><img src={phone} alt="" className='h-4'/> +94 79 890 3876</div>
                    <div className='flex items-center gap-2'><img src={mail} alt="" className='h-4'/> gavel@gmail.com</div>
                  </div>
                </div>
              </div>
            )}
