        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex gap-10 flex-wrap">
            {events.map((event, index) => (
              <div key={index} className="p-4 max-w-[350px] bg-white rounded-2xl shadow-lg">
                <img src={eventImg} alt="Event" className=" h-32 object-cover rounded-t-2xl" />
                <div className="p-4">
                  ...
                  <div className="mt-4 flex justify-between items-center">
                    ...
                    <p className="text-sm text-gray-500 flex gap-2"><IoCalendarOutline className="text-black text-lg" />{event.date}</p>
                    <span
